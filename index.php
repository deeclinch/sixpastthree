...
<header>
    ...
    <nav>
        <div class="bnav">
            <ul class="bnav_list">
                <li class="bnav_item">Articles:</li>
                <li class="bnav_item"><a href="/staff/" class="bnav_link">Games</a></li>
                <li class="bnav_item"><a href="/rpg/" class="bnav_link">Music</a></li>
                <li class="bnav_item"><a href="/wiki/" class="bnav_link">Film &amp; TV</a></li>
                <li class="bnav_item"><a href="/social/" class="bnav_link">Current Events</a></li>
                <li class="bnav_item"><a href="/news/" class="bnav_link">Art &amp; Photography</a></li>
                <li class="bnav_item"><a href="/stats/" class="bnav_link">Lifestyle</a></li>
                <li class="bnav_item"><a href="/contact/" class="bnav_link">Gallery</a></li>
                <li class="bnav_item"><a href="/spm/" class=""><span class="bt_text">Join 03:06</span><span class="bt_icon"></a></li>
            </ul>
        </div>
    </nav>
</header>
...
<div class="greystrip">
    <div class="wrapper">
        ...
        <div id="features" class="row">
            <a href="" class="col features_link">
                <img src="/assets/img/feature.jpg" alt="">
                <span class="features_title">Feature Link Title</span>
            </a>
            <a href="" class="col features_link">
                <img src="/assets/img/feature.jpg" alt="">
                <span class="features_title">Feature Link Title</span>
        ...
        <div class="row">
            <div class="col block">
                <h1 class="h2 block_title">Hello Fellow Procrastinators and Welcome to Six Past <span class="featcolor">Three</span></h1>
                <div class="block_content">
                    ...
                    <img src="/assets/img/team-signature.png" alt="teh 03:06 Team xxx" class="block_signature">
                </div>
            </div>
            <div class="col block">
                <h2 class="h2 title">Six Past <span class="featcolor">Three</span> News Categories</h2>
                <div class="block_content-nav">
                    <nav>
                        <ul class="block_menu">
                            <li class="block_li"><a href="" class="block_link">Forum Modifications</a></li>
                            <li class="block_li"><a href="" class="block_link">New Features</a></li>
                            <li class="block_li"><a href="" class="block_link">Art Challenge Results</a></li>
                            <li class="block_li"><a href="" class="block_link">Category Title Extras</a></li>
                            <li class="block_li"><a href="" class="block_link">Category Title Extras</a></li>
                            <li class="block_li"><a href="" class="block_link">Category Title Extras</a></li>
                            <li class="block_li"><a href="" class="block_link">Category Title Extras</a></li>
                        </ul>
